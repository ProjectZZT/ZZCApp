...
export default class moleScreen extends Component {
  constructor(props) {
    super(props);
  ...
  async _getValue() {
    let result = await AsyncStorage.getItem("mol");
    ...
    return (
      ...
      <View style={styles.list}>
        <View style={styles.listContainer}>
          ...
          <Text style={styles.listResultHeader}>몰(mol)</Text>
          <Text style={styles.listResult}>
            {this.state.rst_value}mol
                  </Text>
