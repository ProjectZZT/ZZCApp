...
export default class meterScreen extends Component {
  ...
  async _getValue() {
    let result = await AsyncStorage.getItem("meter");
    ...
    return (
      ...
      <View style={styles.list}>
        <View style={styles.listContainer}>
          ...
          <Text style={styles.listResultHeader}>미터(m)</Text>
          <Text style={styles.listResult}>
            {this.state.rst_value}m
              </Text>
