...
export default class ampereScreen extends Component {
  constructor(props) {
    super(props);
  ...
  async _getValue() {
    let result = await AsyncStorage.getItem("ampere");
    ...
    return (
      ...
      <View style={styles.list}>
        <View style={styles.listContainer}>
          ...
          <Text style={styles.listResultHeader}>암페어(A)</Text>
          <Text style={styles.listResult}>
            {this.state.rst_value}A
                  </Text>
