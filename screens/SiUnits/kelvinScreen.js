...
export default class kelvinScreen extends Component {
  constructor(props) {
    super(props);
  ...
  async _getValue() {
    let result = await AsyncStorage.getItem("kelvin");
    ...
    return (
      ...
      <View style={styles.list}>
        <View style={styles.listContainer}>
          ...
          <Text style={styles.listResultHeader}>켈빈(K)</Text>
          <Text style={styles.listResult}>
            {this.state.rst_value}K
                  </Text>
