...
export default class candelaScreen extends Component {
  constructor(props) {
    super(props);
  ...
  async _getValue() {
    let result = await AsyncStorage.getItem("cd");
    ...
    return (
      ...
      <View style={styles.list}>
        <View style={styles.listContainer}>
          ...
          <Text style={styles.listResultHeader}>칸델라(cd)</Text>
          <Text style={styles.listResult}>
            {this.state.rst_value}cd
                  </Text>
